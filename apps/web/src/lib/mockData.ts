 ...
 *
 * Дата, від якої все відлічується, — `DEMO_TODAY`. Числа узгоджені між собою
 ...
 */
/**
 * Якір, від якого відлічуються всі дати у файлі. Живе в коді, а не в коментарі,
 * бо на нього спирається перевірка узгодженості (`mockData.test.ts`).
 */
export const DEMO_TODAY = '2 Sep 2026'
